...
function FastScanPlayIcon({ song }: { song: Song }) {
  ...
  return (
    <span
      className={`flex h-5 w-5 items-center justify-center rounded-full transition ${active ? "bg-white text-black opacity-100" : "bg-transparent text-[var(--text-muted)] opacity-0 group-hover:bg-white group-hover:text-black group-hover:opacity-100"}`}
    >
