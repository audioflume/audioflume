...
function isReservedProjectFolderName(value: string) {
...
export default function ProjectDetailPageClient() {
  ...
  const visibleTabs = useMemo(
    () => TABS.filter((tab) => availableTabValues.has(tab.value)),
    [availableTabValues],
  );
        ...
        <div className="project-detail-shell">
          {loading ? (
            ...
            <>
              ...
              <div className="project-tabs-row">
                {visibleTabs.map((tab) => {
                  const isActive = activeProjectTab === tab.value;
                  return (
                    <button
                      key={tab.value}
                      type="button"
