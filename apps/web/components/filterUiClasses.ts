...
export const filterDropdownTitleClass =
  "text-[11px] font-[320] uppercase tracking-[0.08em] text-[var(--text-muted)]";

export const filterClearButtonClass =
  "text-[11px] font-[320] text-[var(--text-secondary)] transition hover:text-[var(--text-primary)]";

export const filterRowButtonClass =
  "flex h-8 w-full cursor-pointer items-center justify-between rounded-lg px-2.5 text-left text-xs font-[320] transition-colors";
...
export const filterSegmentButtonClass =
  "h-7 cursor-pointer rounded-md text-xs font-[320] transition-colors";
...
export const filterSummaryLabelClass =
  "text-[10px] font-[320] uppercase tracking-[0.08em] text-[var(--text-muted)]";

export const filterSummaryValueClass =
  "truncate text-xs font-[320] text-[var(--text-primary)]";

export const filterDotClass =
  "h-1.5 w-1.5 flex-shrink-0 rounded-full bg-[var(--accent)]";

export const filterInputClass =
  "h-8 w-full rounded-lg border border-[var(--border)] bg-[var(--bg-primary)] px-2.5 text-xs font-[320] text-[var(--text-primary)] outline-none placeholder:text-[var(--text-muted)] focus:border-[var(--text-secondary)]";

export const filterIntentButtonClass =
  "flex min-h-10 cursor-pointer flex-col items-center justify-center rounded-lg border border-[var(--border)] px-2 py-2 text-center text-xs font-[320] transition-colors";
