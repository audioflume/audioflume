...
function TabIcon({ value }: { value: ProjectTab }) {
  ...
  if (value === "sound-fx") {
    return (
      <svg viewBox="0 0 24 24" aria-hidden="true">
        <path d="M4 10.3h3.1L11 6.7c.7-.6 1.8-.2 1.8.8v9c0 1-.1.4-1.8-.8l-3.9-3.6H4v-1.8Zm12.4-2.9c1.1 1 1.8 2.6 1.8 4.6s-.7 3.6-1.8 4.6l-1.3-1.3c.8-.7 1.2-1.9 1.2-3.3s-.4-2.6-1.2-3.3l1.3-1.3Zm2.7-2.4c1.8 1.7 2.9 4 2.9 7s-1.1 5.3-2.9 7l-1.3-1.3c1.5-1.4 2.3-3.2 2.3-5.7s-.8-4.3-2.3-5.7l1.3-1.3Z" />
      </svg>
    );
  }
