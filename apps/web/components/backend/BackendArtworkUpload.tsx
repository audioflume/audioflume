      ...
      return (
        <div className="grid gap-2">
          <div className="flex items-center justify-between gap-3">
            ...
            {required ? (
              <span className="text-[11px] text-[var(--text-muted)] font-[320]">Required</span>
            ) : null}
          </div>
        ...
        {previewUrl ? (
          ...
          >
            ...
            <span className="min-w-0 text-left">
              ...
              <span className="mt-1 block text-[11px] leading-4 text-[var(--text-secondary)] font-[320]">
                {dropDescription}
              </span>
            </span>
          </button>
        ...
        <div className="flex items-start gap-[18px] max-[720px]:flex-col">
          ...
          >
            <img
              ...
              className="h-full w-full object-cover"
            />
            <span className="absolute inset-0 flex items-center justify-center bg-[var(--media-overlay-preview)] text-[10px] text-[var(--media-overlay-contrast)] opacity-0 transition group-hover:opacity-100 font-[320]">
              Change image
            </span>
          </button>
          ...
          <div className="flex min-h-[180px] min-w-0 flex-1 flex-col justify-between gap-5 py-1 max-[720px]:min-h-0 max-[720px]:w-full">
            <div>
              ...
              <div className="mt-[5px] text-[11px] leading-4 text-[var(--text-secondary)] font-[320]">
                {help}
              </div>
            </div>
            ...
            <div className="flex flex-wrap gap-2">
              ...
              {allowRemove && onRemove ? (
                <button
                  ...
                  disabled={disabled}
                  onClick={onRemove}
                  className="h-9 rounded-[7px] border border-[var(--border)] bg-[var(--bg-secondary)] px-3.5 text-[11px] text-[var(--text-secondary)] transition hover:text-[var(--text-primary)] disabled:opacity-50 font-[320]"
                >
                  Remove image
                </button>
              ) : null}
