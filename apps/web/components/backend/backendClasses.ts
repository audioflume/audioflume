...
export const backendModalDeleteButtonClass = `${backendModalActionButtonClass} border border-[var(--border)] bg-[var(--bg-primary)] px-3 text-[var(--danger)] hover:bg-[var(--danger-hover)] hover:text-[var(--danger)]`;
