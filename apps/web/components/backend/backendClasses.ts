...
export const backendModalDeleteButtonClass = `${backendModalActionButtonClass} border border-[var(--danger)] bg-transparent px-3 text-[var(--danger)] hover:bg-[var(--danger-hover)] hover:text-[var(--danger)]`;
