  ...
  return (
    <DropdownShell
      ...
      trigger={() => (
        <button
          type="button"
          className="flex h-8 cursor-pointer items-center justify-center rounded-full border border-[var(--border)] px-3 text-[11px] font-[320] text-[var(--text-secondary)] transition hover:bg-[var(--bg-hover-strong)] hover:text-[var(--text-primary)]"
    ...
    >
      <div className="px-2 pb-1 pt-1 text-[10px] font-[320] uppercase tracking-[0.08em] text-[var(--text-muted)]">
        Jump to
      </div>
