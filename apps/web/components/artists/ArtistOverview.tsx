    ...
    <div className="grid gap-4">
      ...
      {artist.hero_image_url ? (
        <section className="filmwave-backend-section overflow-hidden">
          <div className="relative min-h-[355px] select-none overflow-hidden bg-[var(--bg-tertiary)]">
            <img
              ref={heroImageRef}
