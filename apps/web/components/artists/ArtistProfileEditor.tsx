...
function CharacterCount({
  ...
  return (
    <div className="mt-1.5 text-right text-[10px] leading-none text-[var(--text-muted)] font-[320]">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <label className="block">
              ...
              <input
                ...
                className="filmwave-backend-input"
              />
              <div className="mt-1.5 text-[11px] leading-5 text-[var(--text-muted)] font-[320]">
                /artists/{displayedSlug || "artist"}
              </div>
              <CharacterCount value={displayedSlug} maxLength={80} />
              {slugChanged ? (
                <div className="mt-1 text-[11px] leading-5 text-[var(--status-warning)] font-[320]">
