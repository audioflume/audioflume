...
function FieldLabel({ children }: { children: string }) {
  return (
    <span className="mb-1.5 block text-[11px] text-[var(--text-secondary)] font-[320]">
      {children}
    </span>
  );
}
...
export default function ArtistSongEditor({
  ...
  if (loadState === "loading") {
    return (
      <section className="filmwave-backend-section px-5 py-6 text-xs text-[var(--text-muted)] font-[320]">
  ...
  if (loadState === "error") {
    return (
      <section className="filmwave-backend-section p-5">
        <div className="text-xs text-[var(--status-error)] font-[320]">{error}</div>
        <button
          type="button"
          onClick={onClose}
        ...
        <div className="grid min-w-0 gap-4">
          ...
          {reviewFeedback?.notes ? (
            <section className="rounded-[10px] border border-[var(--status-warning,var(--border))] bg-[var(--status-warning-soft,var(--bg-secondary))] px-5 py-4">
              <div className="text-xs text-[var(--status-warning,var(--text-primary))] font-[320]">
                Review feedback
              </div>
              <p className="mt-2 text-xs leading-5 text-[var(--text-primary)] font-[320]">
                {reviewFeedback.notes}
              </p>
            </section>
          ) : null}
          ...
          <section className="filmwave-backend-section">
            ...
            <div className="grid gap-5 px-5 pb-5">
              {!canEditRights ? (
                <div className="rounded-[7px] border border-[var(--border)] bg-[var(--bg-primary)] px-3.5 py-3 text-xs text-[var(--text-muted)] font-[320]">
              ...
              <div>
                <div className="mb-3 flex flex-wrap items-center justify-between gap-3">
                  <div>
                    ...
                    <div className="text-[11px] text-[var(--text-muted)] font-[320]">
        ...
        <aside className="grid h-fit gap-4 xl:sticky xl:top-[88px] xl:mt-14">
          <section className="filmwave-backend-section">
            ...
            <div className="grid gap-2 px-5 pb-5">
              {editWarnings.length > 0 ? (
                <>
                  <div className="rounded-[7px] bg-[var(--status-error-soft,rgba(220,88,79,0.08))] p-3 text-xs leading-5 text-[var(--status-error,#dc584f)] font-[320]">
                    ...
                    <div className="mt-2 text-[11px] leading-5 text-[var(--text-secondary)] font-[320]">
                      {editWarnings[0]}
                  ...
                  {warningsOpen && editWarnings.length > 1 ? (
                    <ul className="grid gap-1.5 rounded-[7px] border border-[var(--border)] bg-[var(--bg-primary)] p-3 text-[11px] leading-5 text-[var(--text-secondary)] font-[320]">
                ...
                <div className="rounded-[7px] bg-[var(--status-success-soft,rgba(72,181,113,0.08))] p-3 text-xs text-[var(--status-success,#48b571)] font-[320]">
                  Ready to save
                </div>
              )}
            </div>
          ...
          {(message || error) ? (
            <section className="filmwave-backend-section">
              ...
              <div className="grid gap-3 px-5 pb-5">
                ...
                {message ? (
                  <div className="rounded-[7px] bg-[var(--bg-tertiary)] p-3 text-xs leading-5 text-[var(--text-secondary)] font-[320]">
                    {message}
                  </div>
                ) : null}
              </div>
          ...
          <section className="filmwave-backend-section">
            ...
            <div className="grid gap-2 px-5 pb-5">
              ...
              {!canEditMetadata ? (
                <div className="text-[11px] leading-5 text-[var(--text-muted)] font-[320]">
