...
export default function ArtistTeamManager({
  ...
  return (
    <div className="grid gap-4">
      ...
      {message ? (
        <div className="filmwave-backend-section px-4 py-3 text-xs font-[320] text-[var(--text-primary)]">
          {message}
        </div>
      ) : null}
      ...
      <section className="filmwave-backend-section overflow-hidden">
        <div className="filmwave-backend-section-header">
          ...
          {!loading ? (
            <span className="text-[10px] font-[320] text-[var(--text-muted)]">
        ...
        {loading ? (
          <div className="flex min-h-[144px] items-center justify-center px-5 text-center text-xs font-[320] text-[var(--text-muted)]">
            Loading team...
          </div>
        ) : members.length === 0 ? (
          <div className="flex min-h-[144px] items-center justify-center px-5 text-center text-xs font-[320] text-[var(--text-muted)]">
              ...
              return (
                ...
                >
                  ...
                  <div className="min-w-[180px] flex-1">
                    <div className="flex flex-wrap items-center gap-2">
                      ...
                      {member.is_current_user ? (
                        <span className="text-[9px] font-[320] text-[var(--text-muted)]">
                          You
                        </span>
                      ) : null}
                    </div>
                    <div className="mt-1 text-[11px] font-[320] text-[var(--text-secondary)]">
                  ...
                  {canManage && !isOwner ? (
                    ...
                    <span className="shrink-0 text-[11px] font-[320] text-[var(--text-secondary)]">
