        ...
        {loading ? (
          ...
          <div className="rounded-[7px] border border-[var(--border)] bg-[var(--bg-secondary)] px-5 py-6">
            ...
            <a
              ...
              className="mt-5 inline-flex h-11 items-center justify-center rounded-none border border-[var(--border)] px-4 text-[14px] font-normal text-[var(--text-primary)] transition hover:border-[var(--text-muted)]"
            >
              ...
              return (
                ...
                >
                  ...
                  <button
                    ...
                    className="inline-flex h-11 shrink-0 cursor-pointer items-center justify-center rounded-none border border-[var(--text-primary)] bg-[var(--text-primary)] px-4 text-[14px] font-normal text-[var(--bg-primary)] transition hover:opacity-80 disabled:cursor-not-allowed disabled:opacity-45"
                  >
                    {claiming
                      ? invitation.ownership_transfer
                        ? "Transferring..."
