...
export default function ArtistPagePreview({
  ...
  if (loading) {
    return (
      <div className="flex min-h-[320px] items-center justify-center text-xs font-[320] text-[var(--text-muted)]">
  ...
  if (loadError || !data) {
    return (
      <div className="flex min-h-[320px] items-center justify-center px-6 text-center text-xs font-[320] text-[var(--text-secondary)]">
  ...
  return (
    ...
    >
      {!layoutReady ? (
        <div className="absolute inset-0 flex items-center justify-center text-xs font-[320] text-[var(--text-muted)]">
          Loading page preview...
        </div>
      ) : null}
      ...
      {canEdit && layoutReady ? (
        ...
        >
          {editError ? (
            <span className="max-w-[320px] text-right text-[11px] font-[320] leading-4 text-[var(--status-error)]">
              {editError}
            </span>
          ) : message ? (
            <span className="text-[11px] font-[320] text-[var(--status-success)]">{message}</span>
          ) : null}
