  ...
  return (
    ...
    >
      ...
      <div className="min-w-0 flex-1">
        <h3 className="flex min-w-0 items-center gap-1.5 text-[13px] leading-none text-[var(--text-primary)] font-[320]">
          <span className="min-w-0 truncate">{song.title}</span>
          {song.licenseType === "premium" ? <PremiumLabel /> : null}
        </h3>

        <div className="mt-1.5 flex min-w-0 items-center gap-1.5 text-[10px] leading-none text-[var(--text-muted)] font-[320]">
