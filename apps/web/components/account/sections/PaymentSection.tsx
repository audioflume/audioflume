  ...
  return (
    <>
          ...
          <div className="p-4">
            <div className="border border-[var(--border)] bg-[var(--bg-primary)] p-3.5">
              <div className="flex flex-wrap items-center justify-between gap-4">
                <div>
                  <div className="text-sm font-[320] text-[var(--text-primary)]">Stripe customer portal not connected yet</div>
                  <div className="mt-1 text-xs font-[320] text-[var(--text-muted)]">
                    Customer ID: {billingProfile?.stripe_customer_id || "Not created"}
                  </div>
                </div>
                <div className="border border-[var(--border)] px-2.5 py-1 text-[11px] font-[320] text-[var(--text-muted)]">
                  Stripe-ready
                </div>
              </div>
            </div>
      ...
      <Card className="mt-4">
        ...
        <div className="px-4 py-6 text-sm font-[320] text-[var(--text-muted)]">No Stripe invoices are connected yet.</div>
      </Card>
    </>
  );
}
