...
export default function AdminSongEditPointsSection({
  ...
  if (!songId) {
    return (
      <div className="rounded-xl border border-[var(--border)] bg-[var(--bg-primary)] p-4">
        ...
        <p className="mt-1 text-xs leading-5 text-[var(--text-secondary)] font-[320]">
  ...
  if (error && !canReview) {
    return (
      <div className="rounded-xl border border-[var(--border)] bg-[var(--bg-primary)] p-4">
        <div className="text-xs text-[var(--status-error,#dc584f)] font-[320]">
          {error}
        </div>
      </div>
    );
  ...
  return (
    ...
    >
      {error && (
        <div className="mb-3 rounded-lg border border-[var(--border)] bg-[var(--status-error-soft,rgba(220,88,79,0.12))] px-3 py-2 text-xs text-[var(--status-error,#dc584f)] font-[320]">
          {error}
        </div>
      )}
