  ...
  return (
    <>
      <style>{`
        ...
        .playlist-detail-page .playlist-detail-rename-input { box-sizing: border-box; display: block; width: 100%; min-width: 0; height: auto; margin: 0; overflow: hidden; border: 0; border-radius: 0; background: transparent; padding: 0; color: var(--text-primary); caret-color: var(--text-primary); font-family: var(--font-zalando-sans), sans-serif; font-size: clamp(22px, 2vw, 32px); font-weight: 200; letter-spacing: -0.055em; line-height: 0.98; outline: none; transform: none !important; white-space: nowrap; }
      `}</style>
      {menu}
      {renameField}
      {playlist && (
