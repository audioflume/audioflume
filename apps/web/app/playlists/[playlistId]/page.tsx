...
export default function PlaylistDetailPage() {
  ...
  return (
    <>
      <style>{`
        ...
        .playlist-detail-kicker { font-size: 10px; font-weight: 320; letter-spacing: 0.1em; text-transform: uppercase; color: var(--text-muted); }
        .playlist-detail-title { margin-top: 8px; max-width: 640px; font-family: var(--font-zalando-sans); font-size: 56px; font-weight: 400; line-height: 0.94; letter-spacing: -0.055em; color: var(--text-primary); }
        .playlist-detail-meta { margin-top: 16px; display: flex; flex-wrap: wrap; align-items: center; gap: 8px; font-size: 11px;
 font-weight: 320; color: var(--text-secondary); }
        ...
        .playlist-detail-search-input { width: 100%; background: transparent; color: var(--text-primary); font-family: var(--font-zalando-sans); font-size: 12px; font-weight: 320; font-style: italic; letter-spacing: normal; line-height: normal; outline: none; }
        ...
        .playlist-detail-empty h2 { font-size: 14px; font-weight: 320; color: var(--text-primary); }
        .playlist-detail-empty p { margin-top: 6px; max-width: 320px; font-size: 12px;
