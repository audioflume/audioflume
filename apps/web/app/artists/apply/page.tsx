      ...
      <section className="px-5 pt-[112px] md:px-8 xl:px-10">
        <div className="mx-auto max-w-[980px]">
          <div className="mb-8 flex items-center justify-between gap-4 border-b border-[var(--border)] pb-4">
            ...
            <Link
              href="/music"
              className="inline-flex h-8 items-center justify-center border border-[var(--border)] bg-[var(--bg-secondary)] px-3.5 text-xs font-[320] text-[var(--text-secondary)] transition hover:border-[var(--text-muted)] hover:text-[var(--text-primary)]"
            >
              Back to music
            </Link>
          </div>
          ...
          <section className="mb-8 grid gap-6 md:grid-cols-[minmax(0,0.92fr)_minmax(280px,0.62fr)] md:items-end">
            <div>
              <div className="mb-3 text-[11px] font-[320] uppercase tracking-[0.08em] text-[var(--text-muted)]">
                Artist application
              </div>
              <h1 className="max-w-[720px] font-[family-name:var(--font-zalando-sans)] text-[clamp(42px,6vw,72px)] font-[400] leading-[0.9] tracking-[-0.07em] text-[var(--text-primary)]">
                Join Audioflume as an artist.
              </h1>
            </div>
            <p className="max-w-[440px] text-sm font-[320] leading-6 text-[var(--text-secondary)] md:justify-self-end">
