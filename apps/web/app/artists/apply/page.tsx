...
export default function ArtistApplyPage() {
  return (
    <main className="artist-apply-page-root min-h-screen bg-[var(--bg-primary)] text-[var(--text-primary)]">
      <section
        className="px-5 pb-[120px] pt-[186px] md:px-8 xl:px-10"
        style={{
          backgroundImage:
      ...
      >
        <div className="mx-auto max-w-[650px]">
          <section className="mb-8">
            <h1 className="m-0 max-w-[650px] font-[family-name:var(--font-aktiv-grotesk)] text-[80px] font-normal leading-[0.98] tracking-[-0.035em] text-white">
