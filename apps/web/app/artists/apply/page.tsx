      ...
      <section className="px-5 pt-[112px] md:px-8 xl:px-10">
        <div className="mx-auto max-w-[980px]">
          ...
          <section className="mb-8 grid gap-6 md:grid-cols-[minmax(0,0.92fr)_minmax(280px,0.62fr)] md:items-end">
            <div>
              <div className="mb-3 text-[11px] uppercase tracking-[0.08em] text-[var(--text-muted)] font-[320]">
                Artist application
              </div>
              <h1 className="max-w-[720px] font-[family-name:var(--font-zalando-sans)] text-[clamp(42px,6vw,72px)] leading-[0.9] tracking-[-0.07em] text-[var(--text-primary)] font-[400]">
                Join Audioflume as an artist.
              </h1>
            </div>
            <p className="max-w-[440px] text-sm leading-6 text-[var(--text-secondary)] md:justify-self-end font-[320]">
