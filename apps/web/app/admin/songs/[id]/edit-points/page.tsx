      ...
      <div className="grid gap-3">
        <section className="flex min-h-[80px] items-center gap-4 rounded-[10px] border border-[var(--border)] bg-[var(--bg-primary)] p-5">
          ...
          <div className="min-w-0">
            ...
            <p className="mt-1 truncate text-xs text-[var(--text-secondary)] font-[320]">
              {typedSong.artist || "Unknown artist"}
            </p>
          </div>

          <div className="ml-auto hidden items-center gap-5 text-xs text-[var(--text-secondary)] md:flex font-[320]">
