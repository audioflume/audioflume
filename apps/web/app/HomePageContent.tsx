...
const HOME_STATEMENT_HEADLINE =
  "Every Track and Sound Effect Built For The Edit.";
  ...
  return (
    <section className="audioflume-home-songs">
      ...
      <div className="mt-5 flex justify-center">
        <Link
          href="/music"
          className="inline-flex h-11 min-w-[280px] items-center justify-center rounded-none bg-[var(--filmwave-neutral-surface)] px-10 text-[14px] font-normal text-[var(--text-primary)] transition-colors hover:bg-[var(--text-primary)] hover:text-[var(--bg-primary)] focus-visible:bg-[var(--text-primary)] focus-visible:text-[var(--bg-primary)] focus-visible:outline-none"
        >
          Explore music library
        </Link>
      </div>
...
function HomeIncludedFeatures() {
  return (
    <section
      ...
      style={{
        marginTop: "clamp(56px, 5vw, 80px)",
        paddingTop: "clamp(64px, 5.5vw, 88px)",
        paddingBottom: "clamp(72px, 6.5vw, 104px)",
      }}
    >
      <div>
      ...
      <div className="audioflume-pricing-includes-list">
        {HOME_INCLUDED_FEATURES.map((feature) => (
